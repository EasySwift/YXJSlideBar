...
@interface YXJSlideContentView () <UIScrollViewDelegate>
{
    BOOL isEnableScroller;
}

@property (strong, nonatomic) UIScrollView *scrollView;
@property (strong, nonatomic) YXJSlideContentViewScrollCallback callback;
...
@implementation YXJSlideContentView

- (instancetype)init
{
    self = [super init];
    if (self) {
        isEnableScroller = YES;
    }
    return self;
}
...
- (void)initScrollView {
    ...
    scrollView.scrollEnabled = isEnableScroller;
